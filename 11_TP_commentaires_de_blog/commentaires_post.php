...
$requete = $bdd->prepare('INSERT INTO commentaires(id_billet,auteur,commentaire, date_commentaire) VALUES(?,?,?,?)'); // j'aimerais rajouter un 4ème paramètre date_commentaire mais SQL ne veut pas de mon CURRENT_TIMESTAMP
...
header('Location: commentaires.php?billet=' . $_POST['id2_billet']);
?>